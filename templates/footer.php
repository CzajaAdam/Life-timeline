<footer class="bg-charcoal-900 border-t border-charcoal-800 w-full z-30">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="index.php" class="flex items-center">
                  <img src="lifelines.png" class="h-7 me-3" alt="LifeLines Logo" />
                  <span class="text-charcoal-50 self-center text-2xl font-semibold whitespace-nowrap">LifeLines</span>
              </a>
          </div>
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  <h2 class="mb-6 text-sm font-semibold text-charcoal-300 uppercase">Resources</h2>
                  <ul class="text-charcoal-400 font-medium">
                      <li class="mb-4">
                          <a href="https://tailwindcss.com/" class="hover:text-caleadon-400 transition">Tailwind CSS</a>
                      </li>
                      <li>
                          <a href="https://flowbite.com/" class="hover:text-caleadon-400 transition">Flowbite</a>
                      </li>
                  </ul>
              </div>
              <div>
                  <h2 class="mb-6 text-sm font-semibold text-charcoal-300 uppercase">Follow us</h2>
                  <ul class="text-charcoal-400 font-medium">
                      <li class="mb-4">
                          <a href="https://github.com/CzajaAdam" class="hover:text-caleadon-400 transition">Github</a>
                      </li>
                      <!-- <li>
                          <a href="#" class="hover:text-caleadon-400 transition">Instagram</a>
                      </li> -->
                  </ul>
              </div>
              <div>
                  <h2 class="mb-6 text-sm font-semibold text-charcoal-300 uppercase">Legal</h2>
                  <ul class="text-charcoal-400 font-medium">
                      <li class="mb-4">
                          <a href="privacy.php" class="hover:text-caleadon-400 transition">Privacy Policy</a>
                      </li>
                      <li>
                          <a href="terms.php" class="hover:text-caleadon-400 transition">Terms &amp; Conditions</a>
                      </li>
                  </ul>
              </div>
          </div>
      </div>
      <hr class="my-6 border-charcoal-800 sm:mx-auto lg:my-8" />
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-charcoal-400 sm:text-center">© 2025 <a href="index.php" class="hover:text-caleadon-400 transition">LifeLines™</a>. All Rights Reserved.
          </span>
          <div class="flex mt-4 sm:justify-center sm:mt-0">
            <a href="#" class="text-charcoal-400 hover:text-caleadon-400 transition">
            ...
            <a href="#" class="text-charcoal-400 hover:text-caleadon-400 transition ms-5">
