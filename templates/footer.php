    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  <h2 class="mb-6 text-sm font-semibold text-charcoal-200 uppercase">Resources</h2>
                  <ul class="text-charcoal-300 font-medium">
                      <li class="mb-4">
                          <a href="https://tailwindcss.com/" class="hover:text-charcoal-50 hover:underline">Tailwind CSS</a>
                      </li>
                      <li>
                          <a href="https://flowbite.com/" class="hover:text-charcoal-50 hover:underline">Flowbite</a>
                      </li>
                  </ul>
              </div>
              <div>
                  <h2 class="mb-6 text-sm font-semibold text-charcoal-200 uppercase">Follow us</h2>
                  <ul class="text-charcoal-300 font-medium">
                      <li class="mb-4">
                          <a href="https://github.com/CzajaAdam" class="hover:text-charcoal-50 hover:underline">Github</a>
                      </li>
                      <!-- <li>
                          <a href="#" class="hover:text-charcoal-50 hover:underline">Instagram</a>
                      </li> -->
                  </ul>
              </div>
              <div>
                  <h2 class="mb-6 text-sm font-semibold text-charcoal-200 uppercase">Legal</h2>
                  <ul class="text-charcoal-300 font-medium">
                      <li class="mb-4">
                          <a href="privacy.php" class="hover:text-charcoal-50 hover:underline">Privacy Policy</a>
                      </li>
                      <li>
                          <a href="terms.php" class="hover:text-charcoal-50 hover:underline">Terms &amp; Conditions</a>
                      </li>
                  </ul>
              </div>
          </div>
      </div>
      <hr class="my-6 border-charcoal-700 sm:mx-auto lg:my-8" />
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-charcoal-300 sm:text-center">© 2025 <a href="index.php" class="hover:text-charcoal-50 hover:underline">LifeLines™</a>. All Rights Reserved.
          </span>
          <div class="flex mt-4 sm:justify-center sm:mt-0">
            <a href="#" class="text-charcoal-300 hover:text-charcoal-50">
            ...
            <a href="#" class="text-charcoal-300 hover:text-charcoal-50 ms-5">
